package com.fuzs.puzzleslib_df.element;
...
import com.fuzs.puzzleslib_df.element.side.IServerElement;
...
public abstract class AbstractElement extends EventListener implements IConfigurableElement, IRegistryElement<AbstractElement> {
    ...
    /**
     * empty element needed for some aspects of {@link com.fuzs.puzzleslib_df.config.ConfigManager}
     */
