...
public class NeoForgeAbstractions implements CommonAbstractions {
    ...
    public DiagonalGlassPaneBlock getDiagonalGlassPaneBlock(Block block) {
        return block instanceof BeaconBeamBlock beaconBeamBlock ?
                new NeoForgeDiagonalStainedGlassPaneBlock(block, beaconBeamBlock.getColor()) :
                new NeoForgeDiagonalGlassPaneBlock(block);
    }
